...
public class MaterialDialog {
    ...
    private class Builder {
        ...
        public void setTitle(int resId) {
            ...
            mTitleView.setTypeface(TypefaceUtils.getRobotoBlack(mContext));
        }
        ...
        public void setMessage(int resId) {
            if (mMessageView != null) {
                ...
                mMessageView.setTypeface(TypefaceUtils.getRobotoRegular(mContext));
            }
        }
        ...
        public void setPositiveButton(String text, final View.OnClickListener listener) {
            ...
            button.setTypeface(TypefaceUtils.getRobotoBlack(mContext));
        ...
        public void setNegativeButton(String text, final View.OnClickListener listener) {
            ...
            button.setOnClickListener(listener);
            button.setTypeface(TypefaceUtils.getRobotoRegular(mContext));
